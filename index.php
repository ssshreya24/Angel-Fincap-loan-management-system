              ...
              <div class="card card-statistics">
                <div class="card-body">
                  <div class="clearfix">
                    <div class="float-left">
                      <h4 class="text-primary">
                        ...
                        <img class="mb-2" src="images/icons0.png" alt="" width="40" height="40">

                      </h4>
                    </div>
                    <div class="float-right">
                      <p class="card-text text-dark" f>Pending Loan Applications</p>
                  ...
                  <p class="text-muted">
                    ...
                    <!-- <img class="mb-2" src="images/icons23.png" alt="" width="40" height="40"> -->
                  ...
                  <div class="clearfix">
                    <div class="float-left">
                      <h4 class="text-danger">
                        ...
                        <img class="mb-2" src="images/icons03.png" alt="" width="55" height="55">
                  ...
                  <div class="clearfix">
                    <div class="float-left">
                      <h4 class="text-warning">
                        ...
                        <img class="mb-2" src="images/icons02.png" alt="" width="55" height="55">
                  ...
                  <div class="clearfix">
                    <div class="float-left">
                      <h4 class="text-success">
                        ...
                        <img class="mb-2" src="images/icons01.png" alt="" width="55" height="55">
                     ...
                     if ($notify) {
                       ...
                       while($result = $notify->fetch_assoc()){
                        ...
                        if ($result['next_date']) {
                         ...
                         $giveNotification = date('d-m-Y',strtotime('+1 months',strtotime($result['next_date'])));
                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                      <div class="card-body">
                        <div class="list-group">
                           ...
                           <a class="list-group-item">Aadhaar Number: <?php echo $result['nid']; ?></a>
