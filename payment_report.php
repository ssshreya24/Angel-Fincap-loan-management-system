...
$iubat='Angel Finecap Limited' ;				

		
		
$pdf->Image('images/trail53.png',10,15,17);

$pdf->Ln();
$pdf-> Cell(20);
$pdf->SetFont('Times','',12);
$pdf->Write(4,'Angel Fincap Limited is a private commercial bank');
$pdf->Ln();
$pdf-> Cell(20);
$pdf->SetFont('Times','',12);
$pdf->Write(4, 'Uttara Model Town, Karnataka 577601, India');
$pdf->Ln();
$pdf-> Cell(20);
$pdf->SetFont('Times','',12);
$pdf->Write(4,'Phone: 0175465465, Email:info@angelfincap.com');
$pdf->Ln();
$pdf-> Cell(20);
$pdf->SetFont('Times','',12);
$pdf->Write(4,'Web: www.angelfincaplimited.com');
$pdf-> Cell(20);
$pdf->SetFont('Times','',8);
