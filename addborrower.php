   ...
   ?>
        ...
        <div class="container">
          ...
          <form action="" method="post" enctype="multipart/form-data" id="add_borrower_form">
            ...
            <div class="form-group row">
              <label for="inputBorrowerUniqueNumber" class="text-right col-2 font-weight-bold col-form-label">Aadhaar ID number</label>                      
              <div class="col-sm-9">
                  <input type="text" name="borrower_nid" class="form-control" id="inputBorrowerUniqueNumber" placeholder="Unique Number" value="">
                  <p class="text-muted">Please Give Aadhaar Number Otherwise You Get Error Message</p>
              </div>
            </div>
            <div class="form-group row">
