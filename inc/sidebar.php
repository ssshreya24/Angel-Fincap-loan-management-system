      ...
      <div class="row row-offcanvas row-offcanvas-right">
          ...
          <ul class="nav">
            <li class="nav-item active">
              <a class="nav-link" href="index.php">
                ...
                <!-- <img src="images/icons/icons51.png" alt=""> -->
          ...
          <!-- borrower option -->
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#borrower-pages" aria-expanded="false" aria-controls="borrower-pages">
                ...
                <img src="images/icons/icons6.png" style="height: 30px; width: 30px;" alt="">
            ...
            <li class="nav-item">
              ...
              <img src="images/icons/icons7.png" style="height: 30px; width: 30px;" alt="">
              <span class="menu-title">Apply for loan</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="loan_application.php">
              <img src="images/icons/icons8.png" style="height: 30px; width: 30px;" alt="">
                <span class="menu-title">Loan applications</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="payloan.php">
              <img src="images/icons/icons9.png" style="height: 25px; width: 25px;" alt="">
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#liability-pages" aria-expanded="false" aria-controls="liability-pages">
                <!-- <img src="images/icons/9.png" alt=""> -->
                <img src="images/icons/icons11.png" style="height: 40px; width: 40px;" alt="">
        ...
        <?php } ?>
             <li class="nav-item">
              ...
              <img src="images/icons/icons10.png" style="height: 30px; width: 30px;" alt="">
